...
CREATE TABLE `orders` (
  ...
  -- payment_method: paypal | cash | etc.
  ...
  -- payment_reference: provider order/transaction ID (e.g., PayPal order ID)
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
-- payments table stores gateway payloads and status for each order payment attempt
CREATE TABLE `payments` (
  `id` int NOT NULL AUTO_INCREMENT,
  `order_id` int NOT NULL,
  -- method: paypal | cash | etc.
  `method` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  -- status: pending | paid | failed
  `status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  -- amount captured/authorized for this payment
  `amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  -- provider_reference: PayPal order ID, gateway txn ref, etc.
  `provider_reference` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  -- payload: raw gateway response (JSON string)
...
INSERT INTO `orders` (`id`,`user_id`,`total`,`delivery_method`,`delivery_address`,`delivery_fee`,`created_at`) VALUES (1,2,2.30,'delivery','Tampines Ave 1',1.50,'2025-11-13 14:21:16'),(2,2,2.30,'delivery','Tampines Ave 1',1.50,'2025-11-13 14:57:18'),(3,2,4.00,'pickup',NULL,0.00,'2025-11-13 15:00:19'),(4,2,1.50,'pickup',NULL,0.00,'2025-11-16 02:58:46'),(5,2,0.80,'pickup',NULL,0.00,'2025-11-18 17:24:27'),(6,2,1.50,'pickup',NULL,0.00,'2025-11-18 17:25:40'),(7,2,3.00,'delivery','Tampines Ave 1',1.50,'2025-11-19 14:11:22'),(11,2,29.40,'pickup',NULL,0.00,'2025-11-20 16:36:46'),(28,7,7.50,'pickup',NULL,0.00,'2025-11-24 15:49:08'),(29,2,6.00,'pickup',NULL,0.00,'2025-11-24 17:56:21'),(30,2,1.50,'pickup',NULL,0.00,'2025-11-24 17:56:49'),(31,2,9.00,'delivery','Tampines Ave 1',1.50,'2025-11-24 18:00:53');
...
INSERT INTO `products` VALUES (1,'Apples',24,1.50,0.00,NULL,'apples.png','General',0),(2,'Bananas',7,0.80,0.00,NULL,'bananas.png','General',0),(3,'Milk',0,3.50,0.00,NULL,'milk.png','General',0),(4,'Bread',80,1.80,9.00,NULL,'bread.png','General',0),(14,'Tomatoes',1,1.50,0.00,NULL,'tomatoes.png','General',0),(19,'Broccoli',25,5.00,20.00,'11','Broccoli.png','General',0),(20,'fish',2,1.00,0.00,NULL,'389900dd859b26489093fb2df80cebf3.jpg','meat',1),(21,'duck meat',8,15.00,0.00,NULL,'duckmeat.jpg','Meat',1),(22,'dick',69,69.00,6.90,NULL,'dog head.webp','General',0);
...
-- Dump completed on 2025-12-04 23:40:11
